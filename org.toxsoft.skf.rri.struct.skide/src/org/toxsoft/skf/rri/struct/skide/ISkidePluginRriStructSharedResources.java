...
public interface ISkidePluginRriStructSharedResources {
  ...
  String MSG_RRI_VALUES_DOWNLOAD   = Messages.getString( "MSG_RRI_VALUES_DOWNLOAD" );   //$NON-NLS-1$
  String FMT_RRI_VALUES_DOWNLOADED = Messages.getString( "FMT_RRI_VALUES_DOWNLOADED" ); //$NON-NLS-1$
  String STR_RRI_VALUES_DOWNLOAD   = Messages.getString( "STR_RRI_VALUES_DOWNLOAD" );   //$NON-NLS-1$
  String STR_RRI_VALUES_DOWNLOAD_D = Messages.getString( "STR_RRI_VALUES_DOWNLOAD_D" ); //$NON-NLS-1$
